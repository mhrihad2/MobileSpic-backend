...
app.put("/api/change-email", verifyToken, async (req, res) => {
...
// 👇 এখানে বসাবে তোমার নতুন role change API
app.put("/admin/user/:id/role", verifyToken, verifyAdmin, async (req, res) => {
  const { role } = req.body;
